...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/metro/css/theme.css?v=5.1.3&nocache=1690665836ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="190">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=time-tracker-db&table=user_roles">`time-tracker-db`.`user_roles`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=playground&table=user_roles">`playground`.`user_roles`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=playground&table=roles">`playground`.`roles`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=playground&table=users">`playground`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=playground&table=reviews">`playground`.`reviews`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=playground&table=products">`playground`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=signintrial&table=newuser">`signintrial`.`newuser`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=time-tracker-db&table=time_in">`time-tracker-db`.`time_in`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=time-tracker-db&table=timesheet">`time-tracker-db`.`timesheet`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=time-tracker-db&table=user">`time-tracker-db`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link"><a class="ajax favorite_table_anchor" href="index.php?route=/database/structure/favorite-table&db=time-tracker-db&ajax_request=1&favorite_table=user&remove_favorite=1" title="Remove from Favorites" data-favtargetn="ae7ff759e28b8f0577dbe86a3fa207a9" ><span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_favorite">&nbsp;</span></a><a href="index.php?route=/table/recent-favorite&db=time-tracker-db&table=user">`time-tracker-db`.`user`</a></li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="796129247538525b2364692b326c3832">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="190"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="playground" targettable="roles">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `roles`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="playground" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="playground" targettable="user_roles">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_roles`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="playground" targettable="roles">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `users` ADD UNIQUE(`email`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="playground" targettable="roles">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `roles`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="playground" targettable="reviews">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `roles`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="playground" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_roles`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="time-tracker-db" targettable="user_roles">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
